    ...
    useEffect(() => {
        ...
        const fileChart: ChartData = {
            datasets: [
                {
                    data: [300, 100],
                    backgroundColor: [documentStyle.getPropertyValue('--primary-600') || '#36459a', documentStyle.getPropertyValue('--primary-100') || '#d1d5ed'],
                    hoverBackgroundColor: [documentStyle.getPropertyValue('--primary-700') || '#2c397f', documentStyle.getPropertyValue('--primary-200') || '#acb4df'],
