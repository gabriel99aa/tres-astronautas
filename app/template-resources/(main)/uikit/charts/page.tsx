...
const ChartDemo = () => {
    ...
    useEffect(() => {
        ...
        const textColorSecondary = documentStyle.getPropertyValue('--text-color-secondary') || 'rgba(0, 0, 0, 0.6)';
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border') || 'rgba(0, 0, 0, 0.12)';
