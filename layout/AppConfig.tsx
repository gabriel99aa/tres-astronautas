...
const AppConfig = (props: AppConfigProps) => {
    const { layoutConfig, setLayoutConfig, layoutState, setLayoutState, isSlim, isSlimPlus } =
    ...
    return (
        <>
            ...
            <Sidebar
                ...
                position="right"
                className="layout-config-sidebar"
                style={{ width: '18rem' }}
            >
                {!props.minimal && (
                    <>
                    ...
                    <>
                        ...
                        <div className="field-radiobutton">
                            <RadioButton
                                name="menuTheme"
                                value="colorScheme"
                                checked={layoutConfig.layoutTheme === 'colorScheme'}
